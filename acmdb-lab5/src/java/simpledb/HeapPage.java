...
public class HeapPage implements Page {
    ...
    public void deleteTuple(Tuple t) throws DbException {
        ...
        int n = t.getRecordId().tupleno();
        if (isSlotUsed(n))
            if (t.equals(tuples[n]))
                markSlotUsed(n, false);
            else throw new DbException("tuple to delete doesn't match");
        else throw new DbException("no tuple is here");
    }
    ...
    private void markSlotUsed(int i, boolean value) {
        ...
        // not necessary for lab1
        byte m = (byte) (1 << i % 8);
        if (value) header[i / 8] = (byte) (header[i / 8] | m);
